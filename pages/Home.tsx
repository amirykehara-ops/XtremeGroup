...
const featuredProducts = allProducts.slice(0, 4);
  return (
    <>
      {/* Hero Section */}
      <section className="relative min-h-[95vh] flex flex-col justify-center items-center overflow-hidden pt-20">
        ...
        <div className="max-w-4xl mx-auto px-6 text-center z-10 relative">
          ...
          >
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-accent mb-6 leading-tight tracking-tight">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {[
            ...
            <motion.div 
              ...
              className="bg-white p-8 rounded-3xl shadow-[0_10px_40px_rgba(0,0,0,0.05)] border border-slate-100 transition-all duration-300 group"
            >
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              { icon: "📦", title: "Entrega", text: "Programada a tu consultorio." }
                ...
                <motion.div
                  key={i}
                  className="bg-accent text-white p-8 rounded-3xl text-center relative shadow-xl shadow-accent/20"
      ...
      <section className="py-24 px-6 bg-gradient-to-br from-blue-50 to-white relative overflow-hidden">
        <div className="max-w-[1000px] mx-auto text-center relative z-10">
          ...
          >
             <img src="images/tokuyama.png" alt="Tokuyama Banner" className="w-full h-64 object-cover rounded-2xl" />
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <input 
              ...
              className="px-6 py-4 rounded-2xl bg-slate-800 border border-slate-700 text-white focus:outline-none focus:border-accent w-full sm:w-80"
            />
